...
class authService {
    registerUser(userData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const finalUserData = Object.assign(Object.assign({}, userData), { password: hashedPassword });
            const savedUser = yield repository.registerUser(finalUserData);
    ...
    loginUser(loginData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield repository.saveRefreshToken(user.id, tokens.refreshToken, expiresAt);
            // 4. Return Data
