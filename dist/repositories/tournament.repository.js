...
class TournamentRepository {
    ...
    // ----------------------------------------------------
    create(organizationId, creatorId, data) {
    ...
    updateStatus(id, status) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield db_1.default.query(query, [status, id]);
            return result.rows[0] || null;
        });
    }
    delete(id) {
    ...
    // ----------------------------------------------------
    registerParticipant(tournamentId, userId, status) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
            ...
            RETURNING *;
        `;
            const result = yield db_1.default.query(query, [tournamentId, userId, status]);
            return result.rows[0];
        });
    }
    cancelRegistration(tournamentId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            RETURNING *;
        `;
            const result = yield db_1.default.query(query, [tournamentId, userId]);
            return result.rows[0];
        });
    }
    getParticipantCount(tournamentId, status) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `SELECT COUNT(*) FROM sm.tournament_participants WHERE tournament_id = $1 AND status = $2`;
            const result = yield db_1.default.query(query, [tournamentId, status]);
            return parseInt(result.rows[0].count, 10);
        });
    }
    getParticipants(tournamentId, status) {
        return __awaiter(this, void 0, void 0, function* () {
            let query = `
    ...
    getOldestWaitlisted(tournamentId) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
        ...
        `;
            const result = yield db_1.default.query(query, [tournamentId]);
            return result.rows[0] || null;
        });
    }
    updateParticipantStatus(tournamentId, userId, status) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
            UPDATE sm.tournament_participants 
            SET status = $1 
            ...
            RETURNING *;
        `;
            const result = yield db_1.default.query(query, [status, tournamentId, userId]);
            return result.rows[0];
        });
    }
    // ----------------------------------------------------
    ...
    checkInParticipant(tournamentId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
             UPDATE sm.tournament_participants 
             SET checked_in = true 
    ...
    logShuttles(tournamentId, userId, brand, quantity) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
            ...
            RETURNING *;
        `;
            const result = yield db_1.default.query(query, [tournamentId, brand, quantity, userId]);
            return result.rows[0];
        });
    }
}
